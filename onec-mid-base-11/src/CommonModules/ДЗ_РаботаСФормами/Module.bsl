...
Процедура ДобавитьКомандуПересчитатьТаблицуВГруппаСкидка(Форма)
	...
	Команда = Форма.Элементы.Добавить("ПересчитатьТаблицу", Тип("КнопкаФормы"), Форма.Элементы.ГруппаСкидка);
	Команда.Вид = ВидКнопкиФормы.ОбычнаяКнопка;
    Команда.ИмяКоманды = "ПересчитатьТаблицу";
